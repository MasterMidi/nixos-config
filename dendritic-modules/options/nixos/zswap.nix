# TODO: remove when PR is merged: https://github.com/NixOS/nixpkgs/pull/470366
        ...
        assertions = [
          {
            ...
            message = ''
              Conflicting options enabled: 'zswap.enable' and 'zramSwap.enable'.
              ...
              Please disable one of them:
                ...
                - To use Zram (swap in RAM): Set 'zswap.enable = false'.
            '';
          }
          {
          ...
          }
          {
            ...
            message = ''
              ...
              Please use 'zbud' instead: zswap.zpool = "zbud";
            '';
          }
        ];
      };
