...
}:
{
  ...
  boot.kernel.sysctl = {
    # Accept RA install
    "net.ipv6.conf.wlp1s0.accept_ra" = 2;
    "net.ipv6.conf.wlp1s0.accept_ra_rt_info_max_plen" = 64;
  ...
  services.k3s = {
    ...
    extraFlags = [
      "--node-ip=192.168.1.50" # Replace with your actual LAN IP
      "--flannel-iface=wlp1s0" # Replace with your WiFi interface name
